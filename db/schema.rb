...
ActiveRecord::Schema.define(version: 20191207155851) do
  ...
  create_table "students", primary_key: "student_id", id: :integer, comment: "ID", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
